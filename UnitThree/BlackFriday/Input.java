...
public class Input {
    ...
    public static int intValid(String prompt) {
        ...
        while (true) {
            ...
            if (input.hasNextInt()) {
                ...
                System.err.println(C_RED + "Invalid Input!");
                input.next();
            }
        }
    ...
    public static String nonEmptyStringValid(String prompt) {
        ...
        do {
            ...
            str = input.nextLine();
            if (str.trim().isEmpty()) {
                System.out.println(C_RED + "Error: Input cannot be empty. Please enter a valid string.");
            }
    ...
    public static boolean booleanValid(String prompt) {
        while (true) {
            ...
            if (inputStr.equals("true") || inputStr.equals("false")) {
                ...
                System.err.println(C_RED + "Invalid Input! Please enter 'true' or 'false'.");
            }
        }
    }
    ...
    public static char charValid(String prompt) {
        while (true) {
            ...
            if (inputStr.length() == 1) {
                ...
                System.err.println(C_RED + "Invalid Input! Please enter a single character.");
            }
        }
    }
    ...
    public static String stringValid(String prompt, int length) {
        while (true) {
            ...
            if (str.length() == length) {
                ...
                System.err.println(C_RED + "Invalid Input! Please enter a string of length " + length + ".");
            }
        }
    }
    ...
    public static String emailValid(String prompt) {
        while (true) {
            ...
            if (email.matches("^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+$")) {
                ...
                System.err.println(C_RED + "Invalid Input! Please enter a valid email address.");
            }
        }
    }
    ...
    public static String dateValid(String prompt) {
        while (true) {
            ...
            if (date.matches("\\d{4}-\\d{2}-\\d{2}")) {
                ...
                System.err.println(C_RED + "Invalid Input! Please enter a date in the format yyyy-MM-dd.");
            }
        }
    }
    ...
    public static boolean yesNoValid(String prompt) {
        while (true) {
            ...
            if (inputStr.equals("y")) {
                ...
                System.err.println(C_RED + "Invalid Input! Please enter 'y' for yes or 'n' for no.");
            }
        }
    }
}